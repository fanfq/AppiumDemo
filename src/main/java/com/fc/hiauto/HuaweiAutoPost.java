...
@Slf4j
public class HuaweiAutoPost implements Runnable{
    ...
    public HuaweiAutoPost(List<String> msgs_,Device device_){
        if(device_!=null){
            device = device_;
        }
     ...
     */
    public void init( List<String> msgs_,Device device_ ) throws MalformedURLException,InterruptedException{
